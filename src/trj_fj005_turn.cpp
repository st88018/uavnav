  ...
  while(ros::ok()){
    ...
    if(mission_state==TURN1)
    {
      static generalMove gm(ros::Time::now().toSec(),
                            uav_lp_p, uav_lp_q,
                            takeoff_x, takeoff_y, altitude_mission,  PI, 
    ...
    if(mission_state==TURN2)
    {
      static generalMove gm(ros::Time::now().toSec(),
                            uav_lp_p, uav_lp_q,
                            takeoff_x, takeoff_y, altitude_mission,  2*PI, 
                            velocity_mission,velocity_angular);
      gm.getPose(ros::Time::now().toSec(),uav_lp_p, uav_lp_q, pose);
      if(gm.finished())
      {
    ...
    if(mission_state==TURN4)
    {
      static generalMove gm(ros::Time::now().toSec(),
                            uav_lp_p, uav_lp_q,
                            takeoff_x, takeoff_y, altitude_mission,  0, 
                            velocity_mission,velocity_angular);
      gm.getPose(ros::Time::now().toSec(),uav_lp_p, uav_lp_q, pose);
      if(gm.finished())
      {
    ...
    if(mission_state==TURN6)
    {
      static generalMove gm(ros::Time::now().toSec(),
                            uav_lp_p, uav_lp_q,
                            takeoff_x, takeoff_y, altitude_mission,  PI*2, 
                            velocity_mission,velocity_angular);
      gm.getPose(ros::Time::now().toSec(),uav_lp_p, uav_lp_q, pose);
      if(gm.finished())
      {
